...
<table class="fold-table mt-5 mb-5">
  <thead>
    ...
    <tr>
      <th>#</th><th>Order Date</th><th>Status</th><th>Amount</th><th>Action </th>
    </tr>
  </thead>
  <tbody>
  ...
  ?>
    ...
    <tr class="fold">
      <td colspan="7">
        ...
        <img class="rounded-circle" src="/Product_image/{{$product->image}}" alt=""
        style="width: 150px;height:150px;">
        <div class="profile-thumb-edit bg-success  text-white"
        data-bs-toggle="tooltip" title="" data-bs-original-title="Change Profile Picture">{{$product->price}}
