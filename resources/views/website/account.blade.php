      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 fw-400 d-flex align-items-center mb-4">Personal Details<a style="margin-left: auto;" data-effect="effect-scale" data-target="#exampleModalCenter" data-toggle="modal" href="exampleModalCenter" data-bs-toggle="modal" class="ms-auto text-2 text-uppercase btn-link"><span class="me-1 ml-100"><i class="fas fa-edit"></i></span>Edit</a></h3>
            <hr class="mx-n4 mb-4">
            ...
            <div class="row gx-3 align-items-center">
              ...
              <p class="col-sm-9 text-3">{{Auth::user()->email}}&nbsp;&nbsp; <span class="bg-success text-white rounded-pill d-inline-block px-2 mb-0"><i class="fas fa-check-circle"></i> Verified </span></p>
            </div>
          ...
          ============================================= -->
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 fw-400 d-flex align-items-center mb-4">Delete Your Account  <button type="button" class="btn btn-danger" style="margin-left: auto;" data-toggle="modal"
